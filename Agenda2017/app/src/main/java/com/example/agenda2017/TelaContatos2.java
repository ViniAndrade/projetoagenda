...
public class TelaContatos2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ClickRecyclerView_Interface  {
    ...
    public void listenersButtons() {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Cria uma nova pessoa chamada Josias
                //É neste método que fazemos a inserção de um novo item na lista
    ...
    public void Ligar(View v){
        Intent i = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:083987087026"));
        startActivity(i);
